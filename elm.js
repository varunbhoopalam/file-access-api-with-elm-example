...
var $author$project$Main$FilePicked = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$messageReceiver($author$project$Main$FilePicked);
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					model,
					$author$project$Main$sendMessage('file_picker'));
			case 1:
				var str = msg.a;
				return _Utils_Tuple2(
					{w: str},
			...
			case 2:
				return _Utils_Tuple2(
					model,
					$author$project$Main$save(model.w));
			default:
				var s = msg.a;
				return _Utils_Tuple2(
					{w: s},
...
var $author$project$Main$Clicked = {$: 0};
var $author$project$Main$Save = {$: 2};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder('File content'),
